...
// If the user alters the query string and the category doesn't exist, $catname will be an empty string 
// (Note: used in breadcrumb.inc.php)
$catname     = "";
$getCategory = "SELECT * FROM categories WHERE cat_id = {$catId}";
$category    = $conn->query($getCategory);

confirmQuery($category);
    ...
    <div class="grid">
      ...
      <article id="<?php echo $post_id; ?>" class="grid-item col-xs-12 col-sm-6">
        <div class="grid-item-content">
          <a href="post.php?catref=<?php echo $catId; ?>&postid=<?php echo $post_id; ?>">
          ...
          <header class="post-header">
            ...
            <a href="post.php?catref=<?php echo $catId; ?>&postid=<?php echo $post_id; ?>" class="post-title"><?php echo $title; ?></a>
            </div>
            ...
            <ul class="post-details list-inline">
              ...
              while ($row = $categories->fetch_assoc()) {
                ...
                if ($cat_id == $catId) {
                    ...
                    echo "<a href='category.php?category={$cat_id}'>{$category}</a>";
                }
                echo "</span>";
              }
              ?>
          ...
          <footer class="post-footer">
            <a href="post.php?catref=<?php echo $catId; ?>&postid=<?php echo $post_id; ?>" class="btn standard-btn">Read</a>
          </footer>
        </div>
      </article>        
      <?php }
