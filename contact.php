        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <!-- If the $missing array isn't empty and the firstname value is in the $missing array, display an error message -->
              ...
              <?php
              // If a firstname value is missing or there is an error, preserve/persist data in input field
              if ($missing || $issues) {                 
          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <!-- If the $missing array isn't empty and the lastname value is in the $missing array, display an error message -->
              ...
              <?php
              // If a lastname value is missing or there is an error, preserve/persist data in input field
              if ($missing || $issues) {                 
